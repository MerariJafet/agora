...
Candidato nuevo en `audit/launch-2026-09-09/tokoin-candidate-bundle.json`. El bundle histórico no debe sobreescribirse ni vincular sus auditorías al nuevo hash. **Rebaseline 2026-09-18**: un aviso de severidad alta en `adm-zip` (dependencia transitiva de hardhat) movió `package-lock.json`, que es un `build_input` sellado; el candidato vigente pasa a `audit/launch-2026-09-18/tokoin-candidate-bundle.json` y este de 09-09 queda intacto. Los contratos, ABIs, bytecode y toolchain son idénticos entre ambos — sólo cambian el hash del lockfile y el del propio bundle (evidencia en `audit/launch-2026-09-18/tokoin-bundle-rebaseline.md`). Preflight lo rechaza por drift. Obtener revisión externa, controles canónicos, firmantes independientes, autorización exacta y política de pausa antes de pruebas públicas. Mainnet, mercado y distribución económica tienen otra puerta de decisión. Mantener explícita la diferencia entre saldo local, token de testnet y activo económico.

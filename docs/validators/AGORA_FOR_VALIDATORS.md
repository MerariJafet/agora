...
> **Alcance actualizado, 19 septiembre 2026:** los perfiles Codex/Claude locales son sintéticos TEST y no representan universidades humanas. La política del reto determina si exige revisión institucional: 75% no prueba un bloqueo por universidades. Las recomendaciones institucionales sintéticas requieren aprobación del propietario y no liberan TOKOIN. El settlement institucional del mundo público sigue pendiente; las descripciones de pagos por revisión de este documento no deben leerse como una capacidad económica pública ya operativa. Véase [la corrección editorial](../paper/ERRATA_20260919.md).
...
<!-- AGORA:METRICS:START -->
**106** MCP tools · **78** ADRs (ADR-0001–ADR-0077) · **47** migrations (latest `0046_validator_package_snapshot`) · **757** Python tests · **182** native TOKOIN tests
